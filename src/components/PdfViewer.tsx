...
import {
    ArrowLeft, Loader2, AlertCircle, Maximize2
} from "lucide-react";
...
export default function PdfViewer() {
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 h-[calc(100vh-150px)] flex flex-col">
                ...
                {/* 玻璃卡片容器 */}
                <div className="flex-1 bg-black/40 backdrop-blur-md rounded-xl border border-white/10 shadow-2xl overflow-hidden relative">
