    ...
    items: [
      {
        ...
        links: [
            { title: "一元函数微分学笔记", url: "/notes/math/analysis-note" },
            { title: "笔记2 (待添加)", url: "/notes/math/analysis-2" }
        ]
      },
      {
        ...
        links: [{ title: "笔记1", url: "/notes/math/real-1" }]
      },
      {
        ...
        links: [{ title: "笔记1", url: "/notes/math/complex-1" }]
      },
      {
        ...
        links: [{ title: "笔记1", url: "/notes/math/functional-1" }]
      },
      {
        ...
        date: "2026-01-10",
        tags: ["ODE", "PDE"],
        links: [{ title: "笔记1", url: "/notes/math/de-1" }]
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        date: "2025-09-15",
        tags: ["Matrix", "SVD"],
        links: [{ title: "笔记1", url: "/notes/math/linear-1" }]
      },
      {
        ...
        links: [{ title: "笔记1", url: "/notes/math/abstract-1" }]
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        links: [{ title: "笔记1", url: "/notes/math/topology-1" }]
      },
      {
        ...
        links: [{ title: "笔记1", url: "/notes/math/diffgeom-1" }]
      }
    ]
  }
];
