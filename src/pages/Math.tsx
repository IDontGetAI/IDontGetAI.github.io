    ...
    items: [
      {
        ...
        links: [
            { title: "一元函数微分学笔记", url: `/note-viewer?src=${encodeURIComponent("https://raw.githubusercontent.com/IDontGetAI/Notebook_AI/main/01%20%20Mathematical%20Basic/02%20%20Analysis/01%20%20%E6%95%B0%E5%88%97%E6%9E%81%E9%99%90.md")}&title=Mathematical Analysis&back=/math&backLabel=返回数学主页` }
        ]
      },
      {
