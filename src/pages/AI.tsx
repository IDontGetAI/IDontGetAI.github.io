...
const notes: ContentData<NoteItem> = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        links: [{ title: "笔记1", url: "/notes/ai/linear-1" }]
      },
      {
        ...
        date: "2025-06-01",
        tags: ["Bayes", "MLE"],
        links: [{ title: "笔记1", url: "/notes/ai/prob-1" }]
      },
      {
        ...
        date: "2025-06-15",
        tags: ["Convex", "SGD"],
        links: [{ title: "笔记1", url: "/notes/ai/opt-1" }]
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        date: "2025-07-01",
        tags: ["Graph", "DP"],
        links: [{ title: "笔记1", url: "/notes/ai/ds-1" }]
      },
      {
        ...
        date: "2025-07-15",
        tags: ["OS", "Concurrency"],
        links: [{ title: "笔记1", url: "/notes/ai/os-1" }]
      },
      {
        ...
        date: "2025-08-01",
        tags: ["GPU", "Parallel"],
        links: [{ title: "笔记1", url: "/notes/ai/arch-1" }]
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        date: "2025-08-15",
        tags: ["Search", "Logic"],
        links: [{ title: "笔记1", url: "/notes/ai/intro-1" }]
      },
      {
        ...
        date: "2025-09-01",
        tags: ["ML", "SVM"],
        links: [{ title: "笔记1", url: "/notes/ai/ml-1" }]
      },
      {
        ...
        links: [{ title: "笔记1", url: "/notes/ai/pattern-1" }]
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        date: "2025-10-01",
        tags: ["DL", "Transformer"],
        links: [{ title: "笔记1", url: "/notes/ai/dl-1" }]
      },
      {
        ...
        date: "2025-10-15",
        tags: ["RL", "PPO"],
        links: [{ title: "笔记1", url: "/notes/ai/rl-1" }]
      },
      {
        ...
        date: "2025-11-01",
        tags: ["SNN", "Brain"],
        links: [{ title: "笔记1", url: "/notes/ai/neuro-1" }]
      }
    ]
  }
];
