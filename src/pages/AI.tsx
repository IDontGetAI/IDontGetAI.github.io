        ...
        links: [
          {
            ...
            url: "https://www.google.com/search?q=Artificial+Intelligence+Online+Course",
            type: "Video",
          },
          {
            title: "Search Books",
            url: "https://www.google.com/search?q=Artificial+Intelligence+Books",
            type: "Book",
          },
          {
            title: "Google Scholar",
            url: "https://scholar.google.com/scholar?q=Artificial+Intelligence",
            type: "Database",
          },
        ],
      },
...
const insights: InsightItem[] = [
  {
    title: "AI 的本质是压缩",
    content:
      "Ilya Sutskever 说过，压缩即智能。大模型通过预测下一个 token，实际上是在寻找训练数据背后最高效的压缩表示。这种压缩迫使模型理解世界的运作规律。",
    date: "2026-01-02",
  ...
  },
  {
    ...
    content:
      "当参数量达到一定规模，模型突然获得了未被显式训练的能力（如思维链 CoT）。这是量变引起质变，还是我们对其内部机制无知的体现？",
    date: "2025-12-30",
  ...
  },
  {
    title: "从连接主义到符号主义的融合",
    content:
      "深度学习（连接主义）擅长感知和模式识别，但缺乏逻辑推理。未来的方向可能是神经符号 AI (Neuro-Symbolic AI)，结合两者的优势，实现真正的 System 2 推理。",
    date: "2026-01-15",
