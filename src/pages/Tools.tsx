          ...
          {filteredTools.map((tool, index) => (
            <Card
              ...
              className={cn(
                ...
                tool.featured
                  ? "border-l-4 border-l-primary shadow-[inset_10px_0_20px_-10px_rgba(var(--primary),0.1)]"
                  : "",
              )}
            >
              {tool.featured && (
              ...
              <CardContent className="flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between mt-auto pt-2 border-t border-white/5">
                  <Badge
                    variant="outline"
                    className="border-white/10 text-[10px] text-muted-foreground group-hover:border-primary/30 group-hover:text-primary/70 font-mono"
                  >
                    {tool.category}
                  </Badge>
                </div>
