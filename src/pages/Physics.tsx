...
const notes: ContentData<NoteItem> = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        content:
          "电荷与电流产生场。高斯定律、安培环路定理。变化的磁场产生电场（法拉第感应），变化的电场产生磁场（麦克斯韦位移电流）。",
        date: "2025-08-20",
        tags: ["Maxwell", "Fields"],
        links: [
      ...
      },
      {
        ...
        content:
          "黑体辐射、光电效应开启了量子的大门。狭义相对论重塑了时空观：时间膨胀、尺缩效应。",
        date: "2025-09-15",
    ...
    items: [
      {
        ...
        content:
          "拉格朗日量 (Lagrangian) 与哈密顿量 (Hamiltonian)。最小作用量原理是物理学的最高法则。",
        date: "2025-10-01",
        tags: ["Lagrangian", "Action"],
        links: [
          {
            title: "笔记（待添加）",
            url: "/notes/physics/analytical-mechanics-1",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        content:
          "希尔伯特空间中的态矢量。薛定谔方程。海森堡不确定性原理。全同粒子与自旋。",
        date: "2025-11-10",
        tags: ["Schrodinger", "Spin"],
        links: [
          {
            title: "笔记（待添加）",
            url: "/notes/physics/quantum-mechanics-1",
          },
        ],
      },
      {
        ...
        content:
          "从微观状态到宏观性质的桥梁。配分函数 (Partition Function) 是核心。玻尔兹曼分布。相变与临界现象。",
        date: "2025-12-05",
        tags: ["Boltzmann", "PhaseTransition"],
        links: [
          {
            title: "笔记（待添加）",
            url: "/notes/physics/statistical-mechanics-1",
          },
        ],
      },
    ],
    ...
    items: [
      {
        ...
        links: [
          {
            title: "笔记（待添加）",
            url: "/notes/physics/complex-variables-1",
          },
        ],
      },
      {
        ...
        content:
          "分离变量法求解偏微分方程。格林函数 (Green's Function) 方法。特殊函数（勒让德、贝塞尔）。",
        date: "2026-01-15",
      ...
      },
      {
        ...
        content:
          "对称性的数学描述。李群与李代数。粒子物理标准模型建立在 SU(3)xSU(2)xU(1) 规范群之上。",
        date: "2026-02-01",
      ...
      },
      {
        ...
        content:
          "广义相对论的语言。流形、联络、曲率。杨-米尔斯场论的几何意义。",
        date: "2026-02-20",
        tags: ["GR", "Topology"],
        links: [
    ...
    items: [
        ...
        links: [
          {
            ...
            url: "https://www.google.com/search?q=Physics+Online+Course",
            type: "Video",
          },
          {
          ...
          },
          {
            ...
            url: "https://scholar.google.com/scholar?q=Physics",
            type: "Database",
          },
        ],
      },
      {
        ...
        links: [
          ...
          {
            title: "Search Books",
            url: "https://www.google.com/search?q=Physics+Books",
            type: "Book",
          },
          {
            title: "Google Scholar",
...
const insights: InsightItem[] = [
  {
    title: "决定论的终结",
    content:
      "牛顿力学让我们相信如果知道所有粒子的位置和动量，就能预测未来。但海森堡不确定性原理打破了这个幻梦。微观世界本质上是概率的，上帝确实在掷骰子。",
    date: "2025-11-30",
  ...
  },
  {
    title: "对称性指引物理定律",
    content:
      "诺特定理 (Noether's Theorem) 告诉我们，每一个连续对称性都对应一个守恒量。时间平移对称对应能量守恒，空间平移对应动量守恒。物理学的终极目标就是寻找对称性。",
    date: "2026-01-10",
  ...
  },
  {
    title: "最小作用量原理",
    content:
      "大自然是一个精明的会计师。光走最短时间路径，粒子走作用量极值路径。费曼路径积分表明，量子粒子实际上“尝试”了所有可能的路径。",
    date: "2026-02-05",
