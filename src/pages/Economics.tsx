    ...
    items: [
      {
        ...
        content: "消费者行为理论（效用最大化）、生产者行为理论（成本最小化）。局部均衡分析。市场结构：完全竞争、垄断、寡头。",
        date: "2025-06-01",
        tags: ["Micro", "Utility"],
        links: [
            { title: "笔记1 (待添加)", url: "/notes/economics/micro-1" },
            { title: "笔记2 (待添加)", url: "/notes/economics/micro-2" }
        ]
      },
      {
        title: "高级微观经济学 (Advanced Micro)",
        content: "一般均衡理论 (General Equilibrium) 与福利经济学第一/第二定理。信息经济学：逆向选择与道德风险。机制设计初步。",
        date: "2025-06-15",
        tags: ["GeneralEquilibrium", "InfoEcon"],
        links: [
            { title: "笔记1 (待添加)", url: "/notes/economics/advanced-micro-1" },
            { title: "笔记2 (待添加)", url: "/notes/economics/advanced-micro-2" }
        ]
      },
      {
        title: "中级宏观经济学 (Intermediate Macro)",
        content: "IS-LM 模型与 AD-AS 模型。短期波动与长期增长。索洛增长模型 (Solow Model)。",
        date: "2025-07-01",
        tags: ["Macro", "IS-LM"],
        links: [
            { title: "笔记1 (待添加)", url: "/notes/economics/macro-1" },
            { title: "笔记2 (待添加)", url: "/notes/economics/macro-2" }
        ]
      },
      {
        title: "高级宏观经济学 (Advanced Macro)",
        content: "微观基础的宏观模型。拉姆齐模型 (Ramsey-Cass-Koopmans)。RBC (实物商业周期) 与 New Keynesian 模型。动态随机一般均衡 (DSGE)。",
        date: "2025-07-20",
        tags: ["DSGE", "Growth"],
        links: [
            { title: "笔记1 (待添加)", url: "/notes/economics/advanced-macro-1" },
            { title: "笔记2 (待添加)", url: "/notes/economics/advanced-macro-2" }
        ]
      },
      {
        title: "中级计量经济学 (Intermediate Econometrics)",
        content: "多元线性回归。高斯-马尔可夫定理。异方差性、自相关性与多重共线性。工具变量法 (IV)。",
        date: "2025-08-01",
        tags: ["Regression", "OLS"],
        links: [
            { title: "笔记1 (待添加)", url: "/notes/economics/econometrics-1" },
            { title: "笔记2 (待添加)", url: "/notes/economics/econometrics-2" }
        ]
      },
      {
        title: "高级计量经济学 (Advanced Econometrics)",
        content: "最大似然估计 (MLE) 与广义矩估计 (GMM)。时间序列分析 (ARIMA, VAR, Cointegration)。面板数据模型。",
        date: "2025-08-15",
        tags: ["MLE", "TimeSeries"],
        links: [
            { title: "笔记1 (待添加)", url: "/notes/economics/advanced-econometrics-1" },
            { title: "笔记2 (待添加)", url: "/notes/economics/advanced-econometrics-2" }
        ]
      }
    ]
  },
    ...
    items: [
      {
        ...
        content: "静态最优化：拉格朗日乘数法，库恩-塔克条件 (KKT)。包络定理。比较静态分析。",
        date: "2025-05-01",
        tags: ["Optimization", "KKT"],
        links: [
            { title: "笔记1 (待添加)", url: "/notes/economics/math-econ-1" },
            { title: "笔记2 (待添加)", url: "/notes/economics/math-econ-2" }
        ]
      },
      {
        title: "博弈论 (Game Theory)",
        content: "纳什均衡 (Nash Equilibrium)。子博弈精炼纳什均衡 (SPE)。贝叶斯纳什均衡。重复博弈与声誉机制。",
        date: "2025-05-15",
        tags: ["Nash", "Strategy"],
        links: [
            { title: "笔记1 (待添加)", url: "/notes/economics/game-theory-1" },
            { title: "笔记2 (待添加)", url: "/notes/economics/game-theory-2" }
        ]
      },
      {
        title: "动态最优化 (Dynamic Optimization)",
        content: "变分法 (Calculus of Variations) 与最优控制理论 (Optimal Control)。哈密顿函数。贝尔曼方程 (Bellman Equation) 与动态规划。",
        date: "2025-09-01",
        tags: ["Hamiltonian", "Bellman"],
        links: [
            { title: "笔记1 (待添加)", url: "/notes/economics/dynamic-optimization-1" },
            { title: "笔记2 (待添加)", url: "/notes/economics/dynamic-optimization-2" }
        ]
      },
      {
        title: "数理经济学 (Mathematical Economics)",
        content: "拓扑学在定点定理中的应用（布劳威尔、角谷）。分离超平面定理。凸分析基础。",
        date: "2025-09-15",
        tags: ["FixedPoint", "Convexity"],
        links: [
            { title: "笔记1 (待添加)", url: "/notes/economics/math-economics-1" },
            { title: "笔记2 (待添加)", url: "/notes/economics/math-economics-2" }
        ]
      }
    ]
  }
