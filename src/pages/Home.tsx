    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-8">
        ...
        <div className="lg:col-span-5 space-y-6">
            {/* Profile Card */}
            <Card className="bg-black/60 border-primary/30 backdrop-blur-md overflow-hidden relative group">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-primary to-transparent opacity-50" />
                <CardContent className="pt-8 text-center space-y-4">
                    <div className="relative mx-auto w-32 h-32 rounded-full border-2 border-primary/50 flex items-center justify-center bg-black overflow-hidden group-hover:border-primary transition-colors">
            ...
            {/* Terminal Bio */}
            <div className="font-mono text-sm bg-black/80 border border-primary/20 rounded-lg p-4 h-[300px] flex flex-col shadow-[0_0_20px_rgba(0,0,0,0.5)]">
        ...
        <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 <Card className="bg-black/40 border-primary/20 hover:bg-primary/5 transition-colors group">
                 ...
                 <Card className="bg-black/40 border-secondary/20 hover:bg-secondary/5 transition-colors group">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-mono text-muted-foreground flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                    ...
                    <Link key={nav.url} href={nav.url}>
                        <div className="h-32 bg-black/40 border border-border/20 rounded-lg p-4 flex flex-col justify-between hover:border-primary/50 hover:bg-primary/5 transition-all cursor-pointer group relative overflow-hidden">
                             ...
                             <nav.icon className={`w-8 h-8 ${nav.color} opacity-80 group-hover:opacity-100 transition-opacity`} />
            ...
            {/* Quote / Footer */}
            <div className="p-6 border-l-2 border-primary/50 bg-gradient-to-r from-primary/5 to-transparent">
                ...
                <p className="text-right text-xs text-primary mt-2">- Albert Camus</p>
            </div>
        </div>
      </div>
    </PageLayout>
