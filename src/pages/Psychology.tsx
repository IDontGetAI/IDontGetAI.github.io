    ...
    items: [
      {
        ...
        content:
          "Kahneman 双系统理论。系统1：快、直觉、省力、易错；系统2：慢、理性、费力。大部分偏差来自系统1的启发式（Heuristics）。",
        date: "2025-06-20",
      ...
      },
      {
        ...
        content:
          "我们的现代头骨里装着石器时代的大脑。焦虑是对捕食者的预警；对糖和脂肪的渴望是对饥荒的适应。理解进化心理学能解释许多“非理性”行为。",
        date: "2025-07-10",
      ...
      },
      {
        ...
        content:
          "神经可塑性 (Neuroplasticity)：大脑并非定型，而是通过经验不断重塑。Hebbian Theory: Neurons that fire together, wire together.",
        date: "2025-09-05",
        ...
        links: [
          {
            ...
            url: "https://www.google.com/search?q=Psychology+Online+Course",
            type: "Video",
          },
          {
            title: "Search Books",
            url: "https://www.google.com/search?q=Psychology+Books",
            type: "Book",
          },
          {
            title: "Google Scholar",
            url: "https://scholar.google.com/scholar?q=Psychology",
            type: "Database",
          },
        ],
      },
...
const insights: InsightItem[] = [
  {
    title: "自由意志是幻觉吗？",
    content:
      "Libet 实验显示，在意识到决定之前，大脑已经产生了行动电位。如果你无法控制下一个念头是什么，你是自由的吗？或许我们只是生化算法的旁观者。",
    date: "2025-10-31",
  ...
  },
  {
    ...
    content:
      "左脑是一个解释器 (The Interpreter)。它不断编造故事来合理化我们的行为，即使这些行为由分裂的右脑或潜意识驱动。我们活在自己编织的连贯故事中。",
    date: "2025-12-08",
