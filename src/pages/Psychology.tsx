    ...
    items: [
      {
        ...
        links: [
            { title: "笔记1 (待添加)", url: "/notes/psychology/cognitive-1" },
            { title: "笔记2 (待添加)", url: "/notes/psychology/cognitive-2" }
        ]
      },
      {
        ...
        links: [
            { title: "笔记1 (待添加)", url: "/notes/psychology/evolutionary-1" },
            { title: "笔记2 (待添加)", url: "/notes/psychology/evolutionary-2" }
        ]
      },
      {
        ...
        links: [
            { title: "笔记1 (待添加)", url: "/notes/psychology/neuroscience-1" },
            { title: "笔记2 (待添加)", url: "/notes/psychology/neuroscience-2" }
        ]
      }
    ]
  }
